...
const TopBar = () => {
    ...
    return (
        <div className="flex w-full justify-center p-5 items-center">
            <div className="flex text-gray-500 dark:text-gray-200" onClick={() => setMenu(menu ? false : true)}>
                <FontAwesomeIcon icon={faBars} size="lg"/>
            </div>
            <div className="flex w-full justify-end cursor-pointer select-none items-center">
